...
public class SkoController : MonoBehaviour
{
    ...
    [SerializeField] private bool isGrounded, isFlipped, isFacingBackwards, canMove, isGliding, isRunning;
    ...
    private void FixedUpdate()
    {
        ...
        if (canMove)
        {
            ...
            float multiplySpeedFac = (float)(1 * (isRunning && isGrounded ? stats.runSpeedMult : 1) * (isGliding ? stats.runSpeedMult/1.5 : 1) + stats.moveSpeed/15);
